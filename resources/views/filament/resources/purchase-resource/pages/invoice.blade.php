<x-filament-panels::page>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="flex justify-between items-start mb-5">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800 mt-1">Supplier Details</h2>
                <div class="mt-2 text-sm text-gray-500 space-y-1">
                    ...
                    @if ($purchase->product)
                        @foreach ($purchase->product as $product)
                            <tr>
                                ...
                                <td class="border border-gray-400 p-4 text-sm font-medium text-gray-800">${{ number_format($product->quantity * $product->price, 2) }}</td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
